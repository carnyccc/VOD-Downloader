...
try:
    ...
    for line in lines:
        if line.startswith('#EXTINF:'):
            ...
            if main_folder != current_main_folder:
                ...
                if not os.path.exists(main_folder):
                    try:
                        ...
                        print(f'Ordner erstellt: {main_folder}')
                    except OSError as e:
                        print(f'Fehler beim Erstellen des Ordners "{main_folder}": {str(e)}')
                        exit(1)
            ...
            download_path = os.path.join(main_folder, sub_folder, current_filename)
